...
class MatDataLoader(Dataset):
    def __init__(self, data_length, base_dir):
        ...
        self.theta_Ddot =  torch.cat([self.theta_1_Ddot, self.theta_2_Ddot, self.theta_3_Ddot], dim = 1).unsqueeze(-1)    
        ...
        self.s_Ddot =  torch.cat([self.x_Ddot * 0.001, self.y_Ddot * 0.001, self.z_Ddot * 0.001], dim = 1)  
