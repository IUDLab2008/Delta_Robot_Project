%-----------------Define underlying parameters---------------------%
                %---Mass properties - Deducted from CAD model---%
m_1 = 22.80*10^-3;                             %---Mass of Active Link---%
m_2 = 150*10^-3;                               %---Mass of Simplified Passive Link---%
m_0 = 14*10^-3;                                %---Mass of End-Effector---%
...
for i = 3:49998
    ...
    tau(:, :, i) = I * angle_Ddot + G - K * inv(A) * B + F_v * angle_dot + F_c * sign(angle_dot);
...
%save("tau_1.mat", "tau_first_row", "tau_second_row", "tau_third_row")